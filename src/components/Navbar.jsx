...
import { getSearchSong, setSearch } from '../redux/APISlice';
    ...
    <nav className='md:ml-8 ml-2 mt-4 flex justify-between md:gap-2 gap-1'>
      ...
      <div className="space-x-3 flex items-center md:gap-2 gap-1 md:hover:cursor-pointer">
        ...
        <div className='relative'>
          <input onChange={(e) => setSearchInput(e.target.value)} type="search" name="search" id="src" placeholder='Search song, artist, album' className='outline-none rounded-md p-1 pl-[40px] lg:w-[90%] w-[100%] lg:text-sm text-base text-gray-500' style={{ "boxShadow": "rgba(17, 12, 46, 0.15) 0px 48px 100px 0px" }} />
